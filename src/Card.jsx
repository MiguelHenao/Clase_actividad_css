...
export default function Card (){
    ...
    return (
        <div className="max-w-sm mx-auto p-6 bg-white shadow-md rounded-lg">
            ...
            <h2 className="mt-4 text-2xl font-semibold text-gray-800 text-center"> JUAN CUBIDES </h2>
            <p className="mt-2 text-gray-600 text-center"> Desarrolladora Front End apasionado por lo penes </p>
            <button 
                onClick={toggletheme}
